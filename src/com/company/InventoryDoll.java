...
public class InventoryDoll {
    String nameHero;
    Item[] equippedItem = new Item[4];
    static List<Item> equipItem(List<Item> invent, Item[] equipInvent){
        ...
        Item removeItem;
        Item[] newEquipInvent = new Item[4];
        for (int i = 0; i < equipInvent.length; i++){
            if (invent.get(targetItem).category.equals(equipInvent[i].category)){
